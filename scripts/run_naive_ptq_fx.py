...
def main():
    ...
    save_path = os.path.join(model_dir, "mnv2_eurosat_fx_naive_ptq_int8.pth")
    ...
    log_file = os.path.join(log_dir, "fx_naive_ptq_mnv2_eurosat_int8.csv")

    with open(log_file, "a") as f:
        f.write(f"{args.dataset},{args.model},FX_Naive,{acc*100:.2f}\n")
