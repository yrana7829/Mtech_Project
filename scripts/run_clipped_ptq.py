...
def main():
    ...
    # RUN CLIPPED PTQ
    # -------------------------------
    quant_model = clipped_ptq_fx(model, calib_loader, percentile=99.9)

    print("\nEvaluating clipped PTQ model...\n")
    ...
    save_path = os.path.join(model_dir, "mnv2_eurosat_fx_clipped_ptq_int8.pth")
