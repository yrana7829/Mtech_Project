...
from src.quantization.sensitivity.feature_space_drift import FeatureSpaceDriftAnalyzer
...
def main():
    ...
    # Analyzer
    # ---------------------------------
    analyzer = FeatureSpaceDriftAnalyzer(target_layers, activation_ranges)
    ...
    # Run inference
    # ---------------------------------
    print("\nRunning feature drift analysis...")
    ...
    save_path = os.path.join(
        save_dir, f"{args.model}_" f"{args.dataset}_" f"feature_space_drift.csv"
    )
