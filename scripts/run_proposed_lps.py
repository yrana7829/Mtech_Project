...
from src.quantization.proposed.proposed_lps import apply_proposed_lps
...
def main():
    ...
    print(f"\nProposed LPS Accuracy: {acc*100:.2f}%")

    os.makedirs("results/proposed_results", exist_ok=True)

    with open("results/proposed_results/proposed_lps_results.txt", "a") as f:
