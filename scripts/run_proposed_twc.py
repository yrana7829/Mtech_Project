...
from src.quantization.proposed.proposed_twc import apply_proposed_twc
...
def main():
    ...
    print(f"\nProposed TWC Accuracy: {acc*100:.2f}%")

    os.makedirs("results/proposed_results", exist_ok=True)

    with open("results/proposed_results/proposed_twc_results.txt", "a") as f:
        f.write(
