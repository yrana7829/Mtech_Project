...
from src.quantization.qat.qat_prepare import (
    prepare_mobilenetv2_qat,
)

from src.quantization.qat.qat_trainer import (
    QATTrainer,
)

from src.quantization.qat.qat_convert import (
    convert_qat_model,
)
...
def main(args):
    ...
    print(f"FP32 Test Accuracy: " f"{fp32_acc:.4f}")
    ...
    os.makedirs(
        os.path.dirname(args.quant_save_path),
        exist_ok=True,
    )

    torch.save(
        quant_model.state_dict(),
        args.quant_save_path,
    )
